...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //NOTE: Previous lines are not compatible with my code,
        //      so, functional main program follows
        
        
        Blog myBlog = new Blog();
        
        //Create two new users, basic user and admin
        myBlog.createNewAccount("Admin", "Password1", true);
        myBlog.createNewAccount("BFU1", "1234", false);
        
        //Login with admin and create random topics and posts
        User admin = myBlog.login("Admin", "Password1");
        
        Topic topicSpace = myBlog.addTopic("Space", "Topic containing all posts about space", admin);
        myBlog.addPost("Some new post about SpaceX", "SpaceX", admin);
        myBlog.addPost("Some new post about NASA", "NASA", admin);
