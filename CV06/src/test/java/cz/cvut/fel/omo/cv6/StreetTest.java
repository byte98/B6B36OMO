...
public class StreetTest {
    ...
    @Test
    public void runTrafficLights_simulateControl_theTrafficlightsFollowTheMorningStrategy() throws ParseException {

        // arrange
        LocalDateTime date = LocalDateTime.of(2017,11,6,6,00);
    ...
    @Test
    public void runTrafficLights_simulateControl_theTrafficlightsFollowTheEveningStrategy() throws ParseException {

        // arrange
        LocalDateTime date = LocalDateTime.of(2017,11,6,18,00);
        street = new Street(5,0, date);
